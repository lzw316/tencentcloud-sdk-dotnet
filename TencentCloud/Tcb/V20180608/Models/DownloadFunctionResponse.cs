...
namespace TencentCloud.Tcb.V20180608.Models
{
    ...
    public class DownloadFunctionResponse : AbstractModel
    {
        
        /// <summary>
        /// <p>调用SCF报错的错误码</p>
        /// </summary>
        [JsonProperty("SCFErrorCode")]
        public string SCFErrorCode{ get; set; }

        /// <summary>
        /// <p>调用SCF报错的错误信息</p>
        /// </summary>
        [JsonProperty("SCFErrorMsg")]
        public string SCFErrorMsg{ get; set; }
