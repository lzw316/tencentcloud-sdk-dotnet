...
namespace TencentCloud.Tokenhub.V20260322.Models
{
    ...
    public class DescribeModelQuotaResponse : AbstractModel
    {
        ...
        /// </summary>
        [JsonProperty("TPMInputReservePostPaidLimit")]
        public long? TPMInputReservePostPaidLimit{ get; set; }

        /// <summary>
        /// <p>TPM 预留后付费 output 配额</p>
        /// </summary>
        [JsonProperty("TPMOutputReservePostPaidLimit")]
        public long? TPMOutputReservePostPaidLimit{ get; set; }
