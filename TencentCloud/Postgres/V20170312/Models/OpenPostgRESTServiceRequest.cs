...
namespace TencentCloud.Postgres.V20170312.Models
{
    ...
    public class OpenPostgRESTServiceRequest : AbstractModel
    {
        ...
        /// <p>是否开启外网</p>
        /// </summary>
        [JsonProperty("EnableWanNet")]
        public bool? EnableWanNet{ get; set; }

        /// <summary>
        /// <p>PostgREST服务参数</p>
        /// </summary>
        [JsonProperty("RestConfig")]
        public ParamEntry[] RestConfig{ get; set; }
