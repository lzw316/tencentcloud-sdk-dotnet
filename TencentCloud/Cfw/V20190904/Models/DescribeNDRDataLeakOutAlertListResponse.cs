...
namespace TencentCloud.Cfw.V20190904.Models
{
    ...
    public class DescribeNDRDataLeakOutAlertListResponse : AbstractModel
    {
        ...
        /// </summary>
        [JsonProperty("Data")]
        public DataLeakOutAlertEvent[] Data{ get; set; }
        ...
        /// 目标服务类型可选项
        /// </summary>
        [JsonProperty("DstServiceTypeOptions")]
        public FieldOption[] DstServiceTypeOptions{ get; set; }

        /// <summary>
        /// 风险场景（类型）可选项
        /// </summary>
        [JsonProperty("RiskScenarioOptions")]
        public FieldOption[] RiskScenarioOptions{ get; set; }

        /// <summary>
        /// AI分析任务状态可选项
        /// </summary>
        [JsonProperty("AnalysisStatusOptions")]
        public FieldOption[] AnalysisStatusOptions{ get; set; }
